...
import com.tx.base.primary.mapper.RoleMapper;
import com.tx.base.primary.service.RoleService;
import com.tx.base.primary.service.UserRoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public IPage<Role> findpage(Role role) {
        ...
        return this.page(iPage, new QueryWrapper<Role>().orderByDesc("create_time"));
    }
}
